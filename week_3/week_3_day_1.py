...
# print(f"{name} liked to hum the song {song} while coding. It was so annoying that their teammated would throw {food} unitl {name} would stop singing.")
...
print(min(2, 3))
# #round a number
print(round(2.5)) #rounds to the nearest whole
# # absolute value
